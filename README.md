...
1. **概述**：`GGN_2015` 是一个喜欢按章办事的人，作为一个规则制定爱好者，她决心制定一个用于约束自己日常生活的规范。尽管她无法保证自己的一切行为都符合这一规范，但她会尽力让这一规范与她的日常行为相一致，以方便其他人借助这一规范了解 `GGN_2015` 其人。
...
4. **关于引用方式**：如何在此规范**外**引用本规范中的内容：
   ...
   3. 本规范内条目**不应**（SHOULD NOT）以编号的方式相互引用，示例性引用不属于此类。
5. **关于修改**：如何修改此规范中的内容：
   1. 删除条目：使用删除线划去某一条目即可，删除后该编号仍然存在，只是支配作用被取消。
   2. 修改条目：**不得**（MUST NOT）修改条目 `0.1.1` 以及 `0.6` 的内容，其余条目在主旨变化不大的前提下可以直接修改。
...
6. **书面指代专题**：
   ...
   3. 若你在上下文中提到了类似 “GGN 姐姐” 的说法，**可以**（MAY）使用 “她（she）”。
   4. 但我们**强烈建议**在同一篇文章（或其他类别文本内容）中提及 `GGN_2015` 时**使用统一的指代方式**，以避免读者误解。
   5. 在本文中指代 `GGN_2015` 时应当统一使用 “她（she）”。
      1. 但这并不代表 `GGN_2015` 通常的行文倾向。
      2. 也不代表本文提到了 "GGN 姐姐" 的说法。
...
7. **婚恋专题**：
   ...
   2. `GGN_2015` 认为婚姻终将消亡。
      1. 但 `GGN_2015` 认为这与现行的社会生活习惯并不违背，`GGN_2015` 在婚姻问题上并没有过于激进的政策立场。
...
10. **价值取向专题**：
    1. `GGN_2015` 在价值观上**必须**（MUST）遵循如下的优先序列：
       1. 首先，**应当**（SHOULD）努力通过自己的行为，在不违背自己与对方意愿的前提下，让自己身边的更多人过得更舒适。
       2. 其次，**应当**（SHOULD）在不违背上一条的前提下追求自己的理想抱负。
       3. 最后，**应当**（SHOULD）在不违背前两条的前提下试图改善自己的个人生活。
    2. 从定义上讲 `GGN_2015` 是一个利他主义者，尽管有些人提出这样的观点有 “自我标榜” 之嫌，但是 `GGN_2015` 认为不然。
       1. `GGN_2015` 做符合上述要求的事情，只是由衷觉得开心罢了。能帮到别人的忙，对别人帮助给予必要的报答，这让 `GGN_2015` 觉得自己是一个 “有用” 的人，让自己活下去的动力更多一些。
       2. `GGN_2015` 认为 “利己” 与 “利他” 在一般意义上并不是一个道德问题，而只是一个思维方式上的习惯问题。
       3. `GGN_2015` 在中学阶段的很长时间里苦恼于个人价值的问题。
          1. 对自己而言，她觉得只要吃饱穿暖足以，除此之外没有任何的物质生活的追求。
          2. 但她所处的环境往往并不容许她消极度日，她需要活在永无休止的物质利益相关的竞争中，并努力在竞争中取得成绩，才能符合老师或长辈的期待。而这这种观念让她倍感压力。
          3. 于是，她陷入了对自己价值取向的深深地怀疑，自己到底应不应该以追求自身的物质利益为第一要务。她感受到，这种在吃饱穿暖之外的、对物质利益的追求，其驱动力（在当时的她看来）明显不是来源于自身的实际需要。因此，`GGN_2015` 想从自身出发，找到一条真正属于自己的 “道路”。
          4.  `GGN_2015` 最终努力找到的道路**大概**是如此：努力让自己的存在为周围人的生活带来积极的影响，努力在自己和他人双方都能接受的前提下、以双方都能接受的方式与他人建立友谊，并尽最大可能与周围人在观点上求同存异。从而说服自己，让自己觉得自己值得活在这个世界上。
          5. 尽管这并不是一条一帆风顺的道路，但 `GGN_2015` **应当**（SHOULD）努力实践上一条。
    3. `GGN_2015` **不得**（MUST NOT）排斥利己主义者，除非他们采用了饱受诟病、不择手段或过于急功近利的行为方式。
       1. 资本主义出现后的 100 年内，人类在生产技术的进步比资本主义出现前、过去的一千年里生产力的进步还有多。
       2. 私有制的存在，借助了人的私欲，借助了人改善自身生活境况的动力，从无到有地组织起了高度社会化的工业生产，这无疑是私有制在人类社会中展现出的不可小觑的力量。
       3. 因此 `GGN_2015` 认为，当今时代中 “利己主义” 观念，在客观上，对生产力的发展起到了至关重要的促进作用。对美好生活的追求在很多文化中被视为人与生俱来的本性，往往只有那些发展至极端的、严重侵犯他人利益的利己行为才会受到社会舆论的诟病。
...
4. **性别认同话题**：
   1. 在性别上 `GGN_2015` 的性染色体组为 `XY`，`GGN_2015` 是传统性别意义上的男性，`GGN_2015` 是双性恋者。
   2. 在有关性别的政治立场上 `GGN_2015` 主张对性少数群体的标签进行 “**无害化**”，即社会不应对性少数群体抱有偏见。
      1. 性少数群体受**合法迫害**导致悲剧的情形可以参考阿兰图灵之死，这无疑是人类历史上的悲剧。
   3. `GGN_2015` 认为性少数群体亦当自尊自爱，不得 “倚老卖老”，过分排斥传统性别者，除非其表现出了对性少数群体的明确歧视或敌对态度。
   4. `GGN_2015` 是平等女权的支持者，是极端女权的反对者。
      1. 所谓平等女权就是认为，对自身塑造的倾向以及对从业的选择不应受限于生理性别，根据生理性别限制社会分工的论调在很大程度上属于一种落后于时代及生产力发展成都的歧视性文化观念。
      2. 而极端女权认为，女性即使不承担任何社会经济责任，也应该保持一种所谓的 “人格上的独立” 性，而男性生来就应当为这种所谓的 “独立性” 负责，做 “女王的奴隶”。
      3. 对比两种观点我们会发现，极端女权其实仍然默许了性别在社会分工上的不平等，去追求一种抽象的、没有物质基础的独立性。
      4. 没有 “无权力的义务”，也没有 “无义务的权力”。无论是传统意义上的男性还是女性，都应当自尊自爱。大男子主义者和极端女权的共性在于，他们都脱离物质生产上的平等去谈所谓的 “爱”。
         1. 大男子主义者认为，我不让女性参与劳动，这不是对他们的 “爱” 吗？殊不知是限制了她们在经济上独立的能力，进而限制了她们在人格独立的能力。
         2. 极端女权也有类似的倾向。极端女权者认为，男性在为女性服务这件事上是利索当然的，如果不能做到绝对的服从，那就是没有对自己的 “爱”。
5. **科学技术专题**：
...
4. **软件使用专题**：
   ...
   3. `GGN_2015` **不应**（SHOULD NOT）反对自己或他人使用闭源软件，闭源软件也是现代软件世界的重要组成部分，尽管 `GGN_2015` 认为开源与开放是软件行业的大势所趋。
      1. 在这里我要做一个不是很恰当但是有关联的类比：`GGN_2015` 认为资本主义的消亡是大势所趋，但是由于当今时代全球并没有实现高度的资本化，真正的资本主义的尽头还远没有实现，因此 `GGN_2015` 并不反对现行的市场经济。
      ...
      5. 但在操作系统等最基础的软件工具上，`GGN_2015` 建议使用开源软件。公共的基础设施为技术的进一步发展提供了重要的统一平台，反倒有利于应用软件的多元化发展。
5. **二次元文化专题**：
   ...
   5. 针对二次元不能登大雅之堂的偏见，`GGN_2015` 认为大多 TV 动画作为公开出版物基本上能够秉承着良善的价值理念，反观传统影视作品中也不乏所谓的 “不能登大雅之堂” 的内容。归根结底，动画与真人拍摄的影视作品都属于艺术形式，观众与作者在价值取向上的矛盾不宜归咎于艺术表现形式。
...
2. **食物喜好专题**：
   ...
   3. `GGN_2015` 喜欢喝可乐，`GGN_2015` 不认为百事可乐与可口可乐之间有难以容忍的差异，尽管二者的口味确实并不相同。
   4. `GGN_2015` 喜欢喝康师傅冰红茶（即，好果汁）。
