...
5. **吸烟专题**：
   ...
   2. 吸烟是当今社会一种常见的现象，`GGN_2015` **不应**（SHOULD NOT）表现出对吸烟者的歧视。
...
8. **公共场合行为专题**：
   ...
   4. `GGN_2015` **不应**（SHOULD NOT）在除公厕外的公共场合随地小便，**不得**（MUST NOT）在除公厕外的公共场合随地大便。
9. **其他个人行为专题**：
...
5. **二次元文化专题**：
   ...
   3. `GGN_2015` **必须**（MUST）同时对二次元作品以及非二次元作品的持包容态度，认可不同表现形式具有各自在表达上的优势。
