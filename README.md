...
4. **性别认同话题**：
   ...
   5. `GGN_2015` **可以**（MAY）向其他人解释自己的性别立场，但 `GGN_2015` **不得**（MUST NOT）因为他人不同的性别立场而表现出歧视的态度（除非这些人原本就怀着对异己的恶意）。不同人在性别立场上的不同往往来自于不同的生活经历，只要能做到**彼此尊重、互惠互利、包容差异、和谐共处**，`GGN_2015` 就**不得**（MUST NOT）抱着在思想上 “同化” 他人的的态度行事。
