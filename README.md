...
1. **总则**：
   ...
   5. 只要对方能够给出让 `GGN_2015` 觉得符合 `GGN_2015` 自己判断的解释，`GGN_2015` 欢迎他人**批评**她的审美倾向。
      ...
      2. 因此，如果不过不想被 “挂”，`GGN_2015` **建议**他人在与 `GGN_2015` 交流时坚持 “**实事求是**” 以及 “**以理服人**” 的立场。
2. **音乐专题**：
   1. **Vocaloid 子专题**：
...
4. **游戏专题**：
   ...
   3. `GGN_2015` 目前**比较喜欢**的游戏列举如下：
      1. `osu!mania4K`：经典音乐游戏 `OSU!` 的四键下落式模式。
      ...
      2. `Celeste`：蔚蓝，赛莱斯特山，综合了解谜和平台跳跃的经典之作。
         1. `cppascalinux` 和 `OldCaptainWZJ` 是 `GGN_2015` 入门 `Celeste` 的老师。
         2. `GGN_2015` 水平不高，但很喜欢这个游戏的**解谜设计与美术、音乐风格**。
